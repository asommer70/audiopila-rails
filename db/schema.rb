...
ActiveRecord::Schema.define(version: 20151120195858) do
  ...
  add_index "playlist_audios", ["audio_id"], name: "index_playlist_audios_on_audio_id", using: :btree
  add_index "playlist_audios", ["playlist_id"], name: "index_playlist_audios_on_playlist_id", using: :btree
